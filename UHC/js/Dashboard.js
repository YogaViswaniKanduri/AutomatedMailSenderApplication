...
var ui = {
	...
	birthday_wishes_page: "ServerStuff/Birthday.php",
	feedback_page: "ServerStuff/Feedbackform.php",
	appointment_reminder_page: "ServerStuff/appointmentRemindForm.php",
    login_page: "ServerStuff/Login.php",
    logout_page: "ServerStuff/Logout.php",
    settings_page: "ServerStuff/Settings.php",
	announcement_page: "ServerStuff/announcement.php",
	reports_page: "ServerStuff/reports.php",
	cronjobs_page: "ServerStuff/automation_jobs.php",
	sentmails_page: "ServerStuff/sentmails.php",
    ...
    */
	...
	sentmails: function () {
        ui.splashScreen(ui.signin_splash_color, ui.signin_splash_icon, function (div) {
            ui.launchApp("sentmails", "sent mails", ui.sentmails_page, function () {
                div.fadeOut();
            });
        });
    },
	...
	birthday: function () {
        ui.splashScreen(ui.signin_splash_color, ui.signin_splash_icon, function (div) {
            ui.launchApp("birthday_wishes", "Birthday Wishes", ui.birthday_wishes_page, function () {
                div.fadeOut();
            });
        });
    },
	
	viewCronJobs: function () {
        ui.splashScreen(ui.signin_splash_color, ui.signin_splash_icon, function (div) {
            ui.launchApp("cronjobs", "Cron jobs", ui.cronjobs_page, function () {
                div.fadeOut();
            });
        });
    },
	...
	feedback: function () {
        ui.splashScreen(ui.signin_splash_color, ui.signin_splash_icon, function (div) {
            ui.launchApp("feedback", "Feedback", ui.feedback_page, function () {
                div.fadeOut();
            });
        });
    },
	...
	appointmentremind: function () {
        ui.splashScreen(ui.signin_splash_color, ui.signin_splash_icon, function (div) {
            ui.launchApp("appointmentremind", "Appointment Reminder", ui.appointment_reminder_page, function () {
                div.fadeOut();
            });
        });
    },
	...
	announcement: function () {
        ui.splashScreen(ui.signin_splash_color, ui.signin_splash_icon, function (div) {
            ui.launchApp("announcement", "Announcement", ui.announcement_page, function () {
                div.fadeOut();
            });
        });
    },
	...
	generateReports: function () {
        ui.splashScreen(ui.signin_splash_color, ui.signin_splash_icon, function (div) {
            ui.launchApp("generateReports", "Generate Reports", ui.reports_page, function () {
                div.fadeOut();
            });
        });
    },
